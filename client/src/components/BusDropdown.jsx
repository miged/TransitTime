...
export default function BusMenu(props) {

  const [clicked, setClicked] = useState(false)
  const className = clicked ? 'expanded-row-content' : 'expanded-row-content hide-row';
  ...
  return (
    <tr onClick={() => toggleable()}>
      ...
      <td>{props.time}</td>
      <td class={className}>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
